...
namespace Arcade.AtTheCrossroads
{
    ...
    {
        /*
         * n tennis, the winner of a set is based on how many games each player wins. The first player to win 6 games is declared the winner unless their opponent had already won 5 games, in which case the set continues until one of the players has won 7 games.
        ...
        public static bool Approach1(int score1, int score2)
        {
            ...
            else if ((score1 >= 6 && score2 < 4) || (score2 >= 6 && score1 < 4))
            {
                return false;
            }
            return false;
